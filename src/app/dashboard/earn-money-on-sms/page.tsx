  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-2xl mt-[120px] mb-10">
      ...
      <p className="text-gray-600 mt-2">
        Earn rewards by referring new users to our platform. Track your invites and
        grow your earnings!
      </p>
      ...
      <div className="mt-5 p-4 bg-gray-100 rounded-lg flex items-center justify-between">
        <div>
          ...
          <a href={referralLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-medium">
            {referralLink}
          </a>
        </div>
      ...
      <div className="mt-6 space-y-4">
        <div className="p-4 bg-gray-50 rounded-lg flex items-center gap-3">
          ...
          <p>Invite unlimited users and earn **3% of their expenses**.</p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg flex items-center gap-3">
      ...
      <div className="mt-6 p-5 bg-gray-200 rounded-lg">
        ...
        <ul className="list-disc pl-5 text-sm text-gray-600 mt-2">
          <li>Withdraw funds to account balance or **USDT TRC-20 wallet**.</li>
          <li>Payouts processed within **24 hours** of request.</li>
          <li>Minimum withdrawal amount: **$10**.</li>
          <li>Fraudulent activity results in referral earnings cancellation.</li>
        </ul>
      </div>

      {/* CTA */}
      <div className="mt-6 text-center">
        <p className="text-gray-600 text-sm">For more details, visit our <a href="/partnership" className="text-blue-500">Partnership Page</a>.</p>
      </div>
    </div>
  );
}
