      ...
      <section className="py-20 bg-gradient-to-br from-blue-700 to-blue-900">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-blue-800/30 backdrop-blur-sm text-white rounded-2xl overflow-hidden w-full max-w-xs border border-blue-500/30 hover:transform hover:scale-105 transition-all">
              <div className="p-6">
          ...
          <div className="max-w-4xl mx-auto bg-blue-700/30 backdrop-blur-sm rounded-3xl border border-blue-500/30 p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="md:w-1/2 flex justify-center">
                <img src="/api/placeholder/400/320" alt="Mobile app screenshot" className="max-w-full rounded-2xl border-4 border-white/20 shadow-lg" />
              </div>
            </div>
          </div>
        </div>
